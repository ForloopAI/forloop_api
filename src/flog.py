...
def wrap_add_class_name(func):
    ...
    def add_class_name(message: str, class_instance=None):
        if class_instance is None:
            class_instance = get_callers_class_instance()

        return func(message, class_instance)
...
@wrap_add_class_name
def critical(message: str = "", class_instance: object = EmptyClass()):
    """
...
@wrap_add_class_name
def error(message: str = "", class_instance: object = EmptyClass()):
    """
...
@wrap_add_class_name
def warning(message: str = "", class_instance: object = EmptyClass()):
    """
...
@wrap_add_class_name
def info(message: str = "", class_instance: object = EmptyClass()):
    """
    print info message
    """
    class_name, class_flog_config_key = get_class_name_config_key_pair(class_instance)
...
@wrap_add_class_name
def minor_info(message: str = "", class_instance: object = EmptyClass()):
    """
...
@wrap_add_class_name
def debug(message: str = "", class_instance: object = EmptyClass()):
    """
    print debug message
    """
    class_name, class_flog_config_key = get_class_name_config_key_pair(class_instance)
